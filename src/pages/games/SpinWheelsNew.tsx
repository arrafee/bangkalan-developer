...
const SpinWheelsNew: React.FC<SpinWheelsNewProps> = ({ className = '' }) => {
  ...
  const defaultPrizes = [...Array(49).fill('Stiker'), ...Array(33).fill('Voucher Diskon Jaket 10%')];
...
SpinWheelsNew.defaultProps = {
  className: '',
};

export default SpinWheelsNew;
